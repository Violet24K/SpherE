...
from openke.module.model import SSRotate3D
...
def main(args):
    ...
    # train the model
        ...
        trainer.run()
        rotate.save_checkpoint('./checkpoint/SSRotate3D_WN18RR_epoch300.ckpt')

    dataset_name = 'WN18RR'
    # test the model
    rotate.load_checkpoint('./checkpoint/SSRotate3D_WN18RR_epoch300.ckpt')
