...
from openke.module.model import SSRotatE, RotatE, Rotate3D, SSRotate3D
...
def main(args):
    ...
    if not args.test:
        ...
        trainer.run()
        rotate.save_checkpoint('./checkpoint/test_SSRotate3D_FB15K237_epoch300.ckpt')

    # test the model
    rotate.load_checkpoint('./checkpoint/test_SSRotate3D_FB15K237_epoch300.ckpt')
