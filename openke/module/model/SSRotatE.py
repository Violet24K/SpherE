...
class SSRotatE(Model):
	...
	def _calc(self, h, t, r, head_radius, tail_radius, mode):		# add head_radius tail_radius
		pi = self.pi_const
		...
		# flatten the score
		score = score.flatten()	#torch.Size([35360])
		# add head_radius tail_radius
		head_radius = torch.nn.functional.relu(torch.norm(head_radius, 1, -1)) #torch.Size([35360])
		tail_radius = torch.nn.functional.relu(torch.norm(tail_radius, 1, -1)) #torch.Size([35360])
		if mode == 'head_batch':
	...
	def helper_dist(self, h, t, r, head_radius, tail_radius, mode):
		pi = self.pi_const
