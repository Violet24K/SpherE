...
from openke.module.model import SSRotatE, RotatE, Rotate3D
...
def main(args):
    ...
    if not args.test:
        ...
        trainer.run()
        rotate.save_checkpoint('./checkpoint/rotate_FB15K237.ckpt')

    # test the model
    rotate.load_checkpoint('./checkpoint/rotate_FB15K237.ckpt')
